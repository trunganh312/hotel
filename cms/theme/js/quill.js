    ...
    var t = {
        ...
        3729: function (t, e, n) {
          ...
          class m extends u.ScrollBlot {
            ...
            insertContents(t, e) {
              ...
              if (s) {
                const e =
                    "block" === s.type &&
                    (0 === s.delta.length() || (!this.descendant(i.zo, t)[0] && t < this.length())),
            ...
            lines() {
              let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                e =
                  arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Number.MAX_VALUE;
              const n = (t, e, r) => {
                let i = [],
                  s = r;
                return (
          ...
          function E(t, e) {
            ...
            for (let e = t.length - 1; e >= 0; e -= 1) {
              const r = t[e];
              (t[e] = { delta: n.transform(r.delta, !0), range: r.range && w(r.range, n) }),
        ...
        6142: function (t, e, n) {
          ...
          class I {
            ...
            constructor(t) {
              ...
              if (
                ((this.options = (function (t, e) {
                  ...
                  const s =
                    !e.theme || e.theme === I.DEFAULTS.theme ? L.A : I.import(`themes/${e.theme}`);
                  ...
                  return (
                    f
                      ? e.formats &&
                        C.warn('Ignoring "formats" option because "registry" is specified')
                      : (f = e.formats
                          ? ((t, e, n) => {
                          ...
                          : d.registry),
                    {
                      ...
                      modules: Object.entries(h).reduce((t, e) => {
                        ...
                        return null == s
                          ? (C.error(`Cannot load ${n} module. Are you sure you registered it?`), t)
            ...
            format(t, e) {
              let n =
                arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : N.A.sources.API;
              return D.call(
                this,
                () => {
            ...
            insertEmbed(t, e, n) {
              let r =
                arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : I.sources.API;
            ...
            setContents(t) {
              let e =
                arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : N.A.sources.API;
              return D.call(
                this,
                () => {
                  t = new (o())(t);
            ...
            update() {
              let t =
                arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : N.A.sources.USER;
        ...
        8298: function (t, e, n) {
          ...
          e.A = class {
            ...
            setRange(t) {
              let e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                n =
                  arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : o.A.sources.API;
            ...
            update() {
              let t =
                arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : o.A.sources.USER;
        ...
        584: function (t, e, n) {
            ...
            k = [
                  ...
                  if (!R(t)) {
                    ...
                    (r = r.replace(/\r\n/g, " ").replace(/\n/g, " ")),
                      ...
                      ((null == t.previousSibling &&
                        ...
                        j(t.parentElement, n)) ||
                        (t.previousSibling instanceof Element && j(t.previousSibling, n))) &&
                        (r = r.replace(/^\s+/, i.bind(i, !1))),
                      ((null == t.nextSibling &&
                        null != t.parentElement &&
                        j(t.parentElement, n)) ||
                        (t.nextSibling instanceof Element && j(t.nextSibling, n))) &&
                        (r = r.replace(/\s+$/, i.bind(i, !1)));
                  }
                  return e.insert(r);
                },
              ...
              [
                ...
                function (t, e, n) {
                  ...
                  if (i.prototype instanceof r.EmbedBlot) {
                    ...
                    (i.prototype instanceof r.BlockBlot && !T(e, "\n") && e.insert("\n"),
                    ...
                    i
                      ...
                      .forEach((e) => {
                        ...
                        (null != i && ((l[i.attrName] = i.value(t)), l[i.attrName])) ||
                          ...
                          null == i ||
                            (i.attrName !== e && i.keyName !== e) ||
                            ((i = L[e]), (l[i.attrName] = i.value(t) || void 0)));
                      }),
              ...
              [
                ...
                function (t, e, n) {
                  ...
                  return null != r
                    ? O(e, "table", Array.from(r.querySelectorAll("tr")).indexOf(t) + 1, n)
                    : e;
                },
              ],
              ["b", B("bold")],
          ...
          class S extends a.A {
            ...
            convert(t) {
              ...
              if (r[d.Ay.blotName])
                return new (s())().insert(n || "", { [d.Ay.blotName]: r[d.Ay.blotName] });
            ...
            dangerouslyPasteHTML(t, e) {
              let n =
                arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : c.Ay.sources.API;
              if ("string" == typeof t) {
          ...
          function R(t) {
            return (
              null != t &&
              (C.has(t) || ("PRE" === t.tagName ? C.set(t, !0) : C.set(t, R(t.parentNode))),
              C.get(t))
            );
          }
                ...
                if (null != s) {
                  ...
                  null != e &&
                    (t
                      ...
                      : this.quill.setSelection(e.offset(this.quill.scroll), 0, a.Ay.sources.USER));
                }
                return !1;
              },
            };
                          ...
                          k =
                            (w =
                              E === -v || (E !== v && h[q - 1] < h[q + 1])
                                ? h[q + 1]
                                : h[q - 1] + 1) - E;
                        w < i && k < o && t.charAt(i - w - 1) === r.charAt(o - k - 1);
                  ...
                  case r:
                    ...
                    if (i) {
                      if (f >= 0 && y(t[f][1])) {
                        var g = t[f][1].slice(-1);
                        if (
                          ((t[f][1] = t[f][1].slice(0, -1)), (h = g + h), (d = g + d), !t[f][1])
                        ) {
                          t.splice(f, 1), l--;
                          var m = f - 1;
                      ...
                      b(t[l][1]) &&
                        ((g = t[l][1].charAt(0)), (t[l][1] = t[l][1].slice(1)), (h += g), (d += g));
                    }
        ...
        4162: function (t, e, n) {
                        ...
                        f || Zt(t)
                          ...
                          : (function (t, e, n, r, o, l, a) {
                              switch (n) {
                                ...
                                case k:
                                  return !(
                                    t.byteLength != e.byteLength || !l(new rt(t), new rt(e))
                                  );
                                case u:
                                case h:
                                case m:
          ...
          (Et.prototype.clear = function () {
            ...
            (qt.prototype.clear = function () {
              (this.size = 0),
                (this.__data__ = { hash: new Et(), map: new (ht || wt)(), string: new Et() });
            }),
            ...
            (t.compose = function (t = {}, e = {}, n = !1) {
              ...
              (t.diff = function (t = {}, e = {}) {
                ...
                const n = Object.keys(t)
                  ...
                  .reduce(
                    (n, r) => (i(t[r], e[r]) || (n[r] = void 0 === e[r] ? null : e[r]), n),
                    {},
                  );
        ...
        5232: function (t, e, n) {
          ...
          class h {
            ...
            concat(t) {
              ...
              return (
                t.ops.length > 0 && (e.push(t.ops[0]), (e.ops = e.ops.concat(t.ops.slice(1)))), e
              );
            }
            diff(t, e) {
        ...
        3558: function (t, e, n) {
          ...
          (h.prototype.clear = function () {
            (this.size = 0),
              (this.__data__ = { hash: new l(), map: new (c.A || a.A)(), string: new l() });
          }),
        ...
        2281: function (t, e, n) {
          ...
          var r,
            ...
            g = function (t) {
              return (
                !(!(0, l.A)(t) || ((e = t), o && o in e)) && ((0, i.A)(t) ? p : c).test((0, a.A)(t))
              );
              var e;
            },
            m = function (t, e) {
          ...
          var r = n(2673),
            ...
            k = function (t, e, n) {
              ...
              switch (e) {
                ...
                case "[object RegExp]":
                  return (
                    ((s = new (i = t).constructor(i.source, x.exec(i))).lastIndex = i.lastIndex), s
                  );
                case "[object Symbol]":
            ...
            S = class extends A {
              ...
              optimize(t = [], e = {}) {
                ...
                const i = (t, e = !0) => {
                  ...
                  s = (t) => {
                    n.has(t.domNode) &&
                      (t instanceof A && t.children.forEach(s), n.delete(t.domNode), t.optimize(e));
                  };
                let o = t;
        ...
        class Z extends x.A {
          ...
          format(t, e) {
            t !== Z.blotName
              ...
              : (W.remove(this.domNode), this.domNode.classList.remove(this.statics.className));
          }
          optimize() {
            ...
            handlers: {
              ...
              direction(t) {
                ...
                "rtl" === t && null == e
                  ...
                  : t || "right" !== e || this.quill.format("align", !1, p.Ay.sources.USER),
          ...
          buildPickers(t, e) {
            (this.pickers = Array.from(t).map((t) => {
              if (
                ...
                (null == t.querySelector("option") && kt(t, vt), "object" == typeof e.align)
              )
          ...
          save() {
            ...
            switch (this.root.getAttribute("data-mode")) {
              case "link": {
                ...
                this.linkRange
                  ? (this.quill.formatText(this.linkRange, "link", t, bt.A.sources.USER),
                    delete this.linkRange)
                  : (this.restoreFocus(), this.quill.format("link", t, bt.A.sources.USER)),
